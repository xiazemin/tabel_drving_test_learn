...
// ListVisitors2 mocks base method.
func (m *MockVisitorLister) ListVisitors2(who *greet.VisitorGroup) ([]*greet.Visitor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListVisitors2", who)
	ret0, _ := ret[0].([]*greet.Visitor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListVisitors2 indicates an expected call of ListVisitors2.
func (mr *MockVisitorListerMockRecorder) ListVisitors2(who interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListVisitors2", reflect.TypeOf((*MockVisitorLister)(nil).ListVisitors2), who)
}
